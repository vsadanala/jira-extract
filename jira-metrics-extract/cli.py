...
def main(argv=None):
   ...
   #     )
    ...
    if args.output:
        ...
        header = ['ID', 'Link', 'Name','Priority','CreatedDate'] + cycle_names + ['Type', 'Status', 'Resolution','CycleTime','ReleaseDate'] + field_names + query_attribute_names
        columns = ['key', 'url', 'summary','priority','created_timestamp'] + cycle_names + ['issue_type', 'status', 'resolution','cycle_time','release_date'] + field_names + query_attribute_names
